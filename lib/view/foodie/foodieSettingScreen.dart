...
class FoodieSettingScreen extends StatefulWidget {
  @override
  _FoodieSettingScreenState createState() => _FoodieSettingScreenState();
}

class _FoodieSettingScreenState extends State<FoodieSettingScreen> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body:
            Container(
          child: FoodieSettingScreen(),
        ));
  }

  Widget FoodieSettingScreen()
  {
    return Padding(
